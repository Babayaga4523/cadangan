          ...
          <div className="flex items-center justify-between">
            <div className="flex items-center gap-6">
              ...
              <div>
                ...
                <p className="text-gray-600">Buat tes CBT dengan soal-soal yang lengkap dan terorganisir</p>
              </div>
            </div>
      ...
      <main className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 pb-12">
        <form onSubmit={handleSubmit} className="space-y-8">
          ...
          <div className="bg-white/80 backdrop-blur-sm border border-blue-100 rounded-2xl p-8 shadow-xl shadow-blue-100/50">
            <div className="flex items-center gap-4 mb-6">
              ...
              <div>
                ...
                <p className="text-gray-600">Masukkan detail dasar untuk tes baru Anda</p>
              </div>
            </div>
            ...
            <div className="grid grid-cols-1 gap-6 lg:grid-cols-2">
              <div className="lg:col-span-2">
                ...
                <input
                  ...
                  placeholder="Masukkan judul tes yang jelas dan deskriptif"
                />
              </div>
              ...
              <div className="lg:col-span-2">
                ...
                <textarea
                  ...
                  placeholder="Jelaskan tentang tes ini, materi yang dicakup, dan instruksi khusus untuk siswa"
                />
              </div>
              ...
              <div>
                ...
                <div className="relative">
                  <input
                    ...
                    className="block w-full px-4 py-3 pr-16 border-2 border-gray-200 rounded-xl shadow-sm focus:outline-none focus:ring-2 focus:ring-orange-500 focus:border-orange-500 transition-all sm:text-sm bg-white/50 backdrop-blur-sm"
                  />
                  <div className="absolute inset-y-0 right-0 flex items-center pr-4">
                    <span className="text-gray-500 text-sm font-medium">menit</span>
                  </div>
                </div>
                <p className="text-xs text-gray-500 mt-2">Waktu pengerjaan tes dalam menit (5-300 menit)</p>
              </div>
              ...
              <div className="flex items-center justify-center lg:justify-start">
                <div className="bg-gradient-to-r from-blue-50 to-orange-50 px-6 py-4 rounded-xl border border-blue-100">
                  <div className="text-center">
                    ...
                    <div className="text-sm text-gray-600">Soal Dipilih</div>
                  </div>
                </div>
              </div>
            </div>
          ...
          <div className="bg-white/80 backdrop-blur-sm border border-blue-100 rounded-2xl p-8 shadow-xl shadow-blue-100/50">
            <div className="flex items-center justify-between mb-6">
              <div className="flex items-center gap-4">
                ...
                <div>
                  <h3 className="text-2xl font-bold text-gray-900">Pilih Soal Tes</h3>
                  <p className="text-gray-600">Pilih soal yang akan dimasukkan ke dalam tes</p>
                </div>
              </div>
              ...
              <>
                {isLoading ? (
                  <div className="space-y-4">
                    {[...Array(3)].map((_, i) => (
                      <div key={i} className="bg-gray-50/80 backdrop-blur-sm border border-gray-100 rounded-xl p-6 animate-pulse">
                        ...
                        <div className="flex items-start space-x-4">
                          ...
                          <div className="flex-1 min-w-0">
                            <div className="flex items-start justify-between mb-3">
                              <p className="text-sm font-semibold text-gray-900 line-clamp-2 flex-1 mr-4">
                                {question.question}
                              </p>
                            ...
                            <div className="grid grid-cols-2 gap-3 text-xs text-gray-600 mb-3">
                              <div className="bg-gray-50 px-3 py-2 rounded-lg">
                                <strong className="text-orange-600">A:</strong> {question.option_a}
                              </div>
                              <div className="bg-gray-50 px-3 py-2 rounded-lg">
                                <strong className="text-orange-600">B:</strong> {question.option_b}
                              </div>
                              <div className="bg-gray-50 px-3 py-2 rounded-lg">
                                <strong className="text-orange-600">C:</strong> {question.option_c}
                              </div>
                              <div className="bg-gray-50 px-3 py-2 rounded-lg">
                                <strong className="text-orange-600">D:</strong> {question.option_d}
                              </div>
                            </div>
                          </div>
                        </div>
          ...
          <div className="flex justify-end gap-4">
            <Link
              href="/dashboard/admin/tests"
              className="inline-flex items-center px-8 py-4 border-2 border-gray-300 shadow-sm text-sm font-semibold rounded-xl text-gray-700 bg-white/80 backdrop-blur-sm hover:bg-gray-50 transition-all duration-200"
            >
              Batal
            </Link>
            <button
